...
*NOTE: In 2026, I can no longer recommend Ghostty. While the experience have been great in many ways, I feel like it might deteriorate in the future due to non-existent anti generative AI policy. Some LLM slop (Claude) commits have also been let into the project. All contributions from Claude is genAI slop. This is about morals, and I truly believe Anthropic is one of the most evil companies in existence.*
