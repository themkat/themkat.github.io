...
---
layout: blogpost
title: Books that boost your Java/JVM programming career
...
*EDIT 2026: Added some context that was missing, as well as some updated thoughts.* 

Do reading the books help? Yes, I would say so. Some of these books at least helped me to go from "coding in moms basement" to "professional" enterprise programming. I got good feedback fast in my career, and got to do things like architecture quickly. People also seem to want my opinion on different topics, and I get good feedback when I do talks. These are just quick examples, but I think reading the books on this list can help you grow much faster than if you did not. The information below are not summaries or reviews, but short descriptions about what the books are about and why you should read them. 
...
*Edit August 2026: This book is a bit controversial, and I'm unsure if I would recommend it the same way today. While I agree with most points its critics say, I think they are valid only if you take it as a dogmatic guide where each tip should be followed. That is NOT where I have believed it to be useful. In my view, it is meant as a conversation starter on what constitutes good and readable code. It might also be useful to understand the decisions made in big enterprise codebases. These are often NOT the places where the highest skilled developers work, so you often have to dumb down the code. Clean Code helps with that. If you are following the rules dogmatically, it will also worsen performance to an extreme degree. That might be useful to you, or it might not. I was sold on the idea for a while due to having to work in the JVM enterprise code world. Never doing that again unless I really need money. For general tips on software design, maintenance and readability, "A Philosophy of Software Design" by John Ousterhout is a much better book.*
...
*EDIT 2026: This is a book that can also be taken in a very dogmatic way. Many of the patterns are really useful to know. Even more so to understand design decisions in enterprise code.*
...
*EDIT 2026: This is the absolute best book on the list! It is awesome, and actually teaches you useful high level programming concepts. Even if you end up in an more interesting part of software development, I would still recommend it. Thinking differently helps you grow.*
...
*EDIT 2026: Unsure if I would recommend this today. It might be useful to understand the choices made in enterprise applications w.r.t the SOLID principles.* 

Clean Architecture is mainly about [[https://en.wikipedia.org/wiki/Software_architecture][software architecture]] and structure, with the angle on making it easy to work with and maintainable. While I think the architecture presented is interesting, I think the best parts of this book is the summary of the SOLID principles and of general architecture concepts. SOLID principles might be useful to know for structuring object oriented software, as well as understanding how different libraries and frameworks are structured. 
