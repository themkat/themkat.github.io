...
If you program in Java or Kotlin, and would like to learn more about Reactive with Quarkus, I can recommend the book [[https://amzn.to/3rSmsOA][Reactive Systems in Java: Resilient, Event-Driven Architecture with Quarkus]] (Amazon affiliate link).
